            ...
            <div className="polls-container">
                ...
                }  
                {
                    !this.state.isLoading && !this.state.last ? (
                        ...
                        console.log("entered load more polls in pollslist");
